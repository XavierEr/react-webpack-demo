    ...
    render() {
        ...
        return (
            <div id="page-top">
                ...
                <section className="container features">
                    ...
                    <div className="row features-block">
                        ...
                        <div className="col-lg-6 text-right wow fadeInRight">
                            <img src="img/dashboard.png" alt="dashboard" className="img-responsive pull-right" />
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row">
                            <div className="col-sm-4 wow fadeInLeft">
                                <div className="team-member">
                                    <img src="img/avatar3.jpg" className="img-responsive img-circle img-small" alt="" />
                            ...
                            <div className="col-sm-4">
                                <div className="team-member wow zoomIn">
                                    <img src="img/avatar1.jpg" className="img-responsive img-circle" alt="" />
                            ...
                            <div className="col-sm-4 wow fadeInRight">
                                <div className="team-member">
                                    <img src="img/avatar2.jpg" className="img-responsive img-circle img-small" alt="" />
                    ...
                    <div className="container">
                        ...
                        <div className="row features-block">
                            ...
                            <div className="col-lg-6 text-right m-t-n-lg wow zoomIn">
                                <img src="img/iphone.jpg" className="img-responsive" alt="dashboard" />
                            </div>
                ...
                <section id="testimonials" className="navy-section testimonials" style={marginTopStyle}>
                ...
                <section className="comments gray-section" style={marginTopStyle}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <div className="navy-line"></div>
